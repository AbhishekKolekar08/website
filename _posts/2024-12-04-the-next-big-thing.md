...
Adding to supply chain voes is consumers showcasing range anxiety—unlike an internal combustion vehicle, the range of EVs is <em>substantially</em> affected by the weather, cabin climatization, speed, gross vehicle weight, battery degradation—leaving consumers worried of not reaching their destination, especially if undertaking longer road trips. This is, somewhat, mitigated by the widening network of public superchargers; but these have their own set of issues. [They are not absolutely reliable](https://arxiv.org/ftp/arxiv/papers/2203/2203.16372.pdf) (however, understandable that human misuse can cause this), they are monopolized—with propriety chargers unable to charge other vehicles, [decentralized and privatized](https://www.washingtonpost.com/climate-solutions/2023/04/13/electric-vehicle-charging-network-biden/)—different types of chargers have their own app, payment method, and compatibility, causing annoyance and inconvenience (a typical EV driver may have as many as eight phone apps and several RFID cards to manage all the possible chargers on the road). Not to mention, refuelling an ICE vehicle is just faster. 
<figure>
	<img src="/images/DCFC-network.png" alt="DCFC Network" width="600">
	<figcaption>DC Fast Charging Network</figcaption>
</figure>
...
So says [Kroll](https://www.kroll.com/en/insights/publications/m-and-a/automotive-industry-insights-fall-2024), an independent financial advisory solutions company.
